...
class WorldManager(object):
    ...
    def __init__(self,worldMap,sprite_positions,x,y,dirx,diry,planex,planey):
        self.sprites = [  
              ...
              load_image(pygame.image.load("pics/items/redlight.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/zkey_circle.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/zkey_square.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/zkey_triangle.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/zdoor_texture_0.png").convert(), False, colorKey = (0,0,0)),#número 7
              load_image(pygame.image.load("pics/items/zdoor_texture_1.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/zdoor_texture_2.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/zdoor_texture_3.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/zdoor_texture_4.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/zdoor_texture_5.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/zdoor_texture_6.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/money_black.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/sadface.gif").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/mandel3i.png").convert(), False, colorKey = (0,0,0)),
              load_image(pygame.image.load("pics/items/mandel7i.png").convert(), False, colorKey = (0,0,0)),
        ]
